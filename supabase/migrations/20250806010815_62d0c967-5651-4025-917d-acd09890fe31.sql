-- Drop and recreate functions with new return types that include age
DROP FUNCTION IF EXISTS public.get_professionals_for_public();
DROP FUNCTION IF EXISTS public.get_profile_for_public(uuid);

-- Recreate get_professionals_for_public with age column
...
-- Recreate get_profile_for_public with age column
